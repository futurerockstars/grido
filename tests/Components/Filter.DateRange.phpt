...
class FilterDateRangeTest extends \Tester\TestCase
{
    ...
    public function testGetCondition()
    {
        ...
        Assert::same(['datetime BETWEEN ? AND ?', '2012-12-21 22:35:00', '2012-12-22 08:05:00'], $filter->__getCondition('21/12/2012 22:35 - 22/12/2012 08:05')->__toArray());

        $filter->setDateFormatInput('d/m/Y g:i');
        Assert::same(['datetime BETWEEN ? AND ?', '2012-12-21 10:35:00', '2012-12-22 08:05:00'], $filter->__getCondition('21/12/2012 10:35 - 22/12/2012 08:05')->__toArray());
    }
}
